...
In this regard, the most used for detecting the presence of animals around the crop field are \acrfullr{pir} sensors. These sensors are passive and use pyroelectric electronics to 
...
\subsubsection*{\acrfullr{rfid} approaches}
